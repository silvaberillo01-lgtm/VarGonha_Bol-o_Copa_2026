...
const ALIASES: Record<string, string> = {
  ...
  // Nomes em inglês como vêm da Football-Data.org -> grafia usada no app.
  // (O valor à direita é o que normalizeTeam() devolve para o nome em PT
  // guardado nos jogos, garantindo que API e banco "casem".)
