...
FROM (VALUES
  ...
  ('oitavas', '2026-07-07 16:00:00-03', 'W83', 'W84',    'M93'),
  ('oitavas', '2026-07-06 21:00:00-03', 'W81', 'W82',    'M94'),
  ('oitavas', '2026-07-06 13:00:00-03', 'W86', 'W88',    'M95'),
  ('oitavas', '2026-07-07 17:00:00-03', 'W85', 'W87',    'M96'),
  -- quartas (provisório)
  ('quartas', '2026-07-10 17:00:00-03', 'W89', 'W90',    'M97'),
  ('quartas', '2026-07-11 16:00:00-03', 'W93', 'W94',    'M98'),
  ('quartas', '2026-07-09 18:00:00-03', 'W91', 'W92',    'M99'),
  ('quartas', '2026-07-10 22:00:00-03', 'W95', 'W96',    'M100'),
  -- semis (provisório)
